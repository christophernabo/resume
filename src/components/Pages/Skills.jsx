    ...
    return (
        <div style={{ display: 'inline-block', width: "80vw", border: "1px solid black ", margin: "10px", borderRadius: "20px" }}>
            ...
            <div style={{ margin: "10px", textAlign: "left" }}>
                <h3 style={{ marginTop: "20px", marginBottom: "5px", textDecoration: "underline" }}>QA Testing</h3>
                <ul>
                ...
                <h3 style={{ marginTop: "50px", marginBottom: "5px", textDecoration: "underline" }}>Web Development</h3>
                <ul>
                    <li>Frontend</li>
                    <ul>
                ...
                <h3 style={{ marginTop: "50px", marginBottom: "5px", textDecoration: "underline" }}>Visual Design</h3>
                <ul>
                    <li>UI/UX Design (Figma, Adobe XD, Adobe Illustrator)</li>
                    <li>Graphic Design (Adobe Illustrator)</li>
                </ul>
                <h3 style={{ marginTop: "50px", marginBottom: "5px", textDecoration: "underline" }}>Language Proficiency</h3>
                <ul>
                    <li>Bicol (native)</li>
