        ...
        <div style={{
            ...
            <div style={{
                ...
                <ul>
                    {showFullList1 ? (
                        <>
                            ...
                            <li>Implement best practices for coding in accordance with W3C standards, great usability and exceptional quality, with awareness of client needs and priorities.</li>
                ...
                <ul>
                    ...
                    <li>Handle minor task tickets that may be specific to software programmer, software tester, or business analyst.</li>
                ...
                <ul>
                    ...
                    <li>Keep an inventory of the computers and their peripheral devices.</li>
