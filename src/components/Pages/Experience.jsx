    ...
    return (
        <div style={{ display: 'inline-block', width: "80vw", border: "1px solid black ", margin: "10px", borderRadius: "20px" }}>
            ...
            <div style={{ margin: "10px", textAlign: "left" }}>
                ...
                <h4 style={{ marginTop: "0", marginBottom: "5px" }}>March 2022 - April 2023</h4>
                ...
                <ul>
                    {showFullList ? (
                        <>
                            ...
                            <li>Work directly with the programming and design teams to investigate and reproduce complex issues;</li>
                            <li>Identify, report and document software defects using provided templates;</li>
                            <li>Participate in events and other activities (e.g., exhibits, meetings, and seminars) needed for the project; and</li>
                            <li>Write documentation of the software, e.g. test plan, testcases, bug reports, technical documentation.</li>
                ...
                <ul>
                    {showFullList1 ? (
                        <>
                            ...
                            <li>Write documentation of the software, e.g. user manual, technical documentation.</li>
                            <li style={{ listStyleType: "none" }}>
                ...
                <ul>
                    <li>Handling minor task tickets that may be specific to software programmer, software tester, or business analyst; and</li>
                    <li>Proactively collaborating with other team members in delivering software requirements.</li>
                </ul>
                ...
                <h4 style={{ marginTop: "0", marginBottom: "5px" }}>June 2019 - September 2019</h4>
                <h4 style={{ marginTop: "0", marginBottom: "5px" }}>Polangui, Albay, Philippines</h4>
                <p>Responsibilities:</p>
                <ul>
                    <li>Maintains the running condition of computer units in the department's laboratory;</li>
                    <li>Performs software installation, computer reformatting, computer assembly and disassembly;</li>
                    <li>Keeps an inventory of the computers and their peripheral devices; and</li>
                    <li>Creates local area network among the computers and switches.</li>
                </ul>
            </div>
            <Footer />
        </div>
